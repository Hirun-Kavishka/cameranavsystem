...
keypoints_ref, descriptors_ref = akaze.detectAndCompute(reference_gray, None)
...
for i in range(1, 5):
    ...
    keypoints_current, descriptors_current = akaze.detectAndCompute(current_gray, None)
